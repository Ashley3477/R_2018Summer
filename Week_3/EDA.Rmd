...
df_payback <- read.csv("DATA/collegesalaries/payback.csv",
...
```
```{r}
df_college_type <- read.csv("DATA/collegesalaries/college_type.csv",
...
dfregion <- read.csv("DATA/collegesalaries/region.csv",
